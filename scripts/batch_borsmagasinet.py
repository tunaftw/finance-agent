#!/usr/bin/env python3
"""
BATCH RUNNER: BÖRSMAGASINET
===========================
Analyserar Börsmagasinet-transkript med GLM-4.7.

ANVÄNDNING:
    cd /Users/pontus/Developer/podcast-transcriber
    python3 scripts/batch_borsmagasinet.py
"""
...
TRANSCRIPT_QUEUE = PROJECT_ROOT / "data" / "extracted" / "glm-batch" / "queue-borsmagasinet.txt"
COMPLETION_LOG = PROJECT_ROOT / "data" / "extracted" / "glm-batch" / "log-borsmagasinet.json"
OUTPUT_DIR = PROJECT_ROOT / "data" / "extracted" / "glm-batch"
BATCH_SIZE = 2
PAUSE_BETWEEN_BATCHES = 2

PODCAST_NAME = "Börsmagasinet"

#!/usr/bin/env python3
"""
BATCH RUNNER: VECKANS TRADE
===========================
Analyserar Veckans Trade-transkript med GLM-4.7.

ANVÄNDNING:
    cd /Users/pontus/Developer/podcast-transcriber
    python3 scripts/batch_veckanstrade.py
"""
...
TRANSCRIPT_QUEUE = PROJECT_ROOT / "data" / "extracted" / "glm-batch" / "queue-veckanstrade.txt"
COMPLETION_LOG = PROJECT_ROOT / "data" / "extracted" / "glm-batch" / "log-veckanstrade.json"

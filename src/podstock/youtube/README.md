...
- `data/youtube/videos/` - Video-metadata
- `data/youtube/transcripts/{channel_id}/` - Transkript (txt)
- `data/youtube_channels.json` - Konfigurerade kanaler
- `data/youtube_state.json` - Collection state

## Konfiguration

Kanaler konfigureras i `data/youtube_channels.json`:

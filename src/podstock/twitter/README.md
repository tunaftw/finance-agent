...
- `data/twitter/analyses/` - Analyserade tweets
- `data/twitter/sources.json` - Konfigurerade källor
- `data/twitter/state.json` - Collection state
- `data/twitter/index/` - Sökindex

## Konfiguration

Twitter-källor konfigureras i `data/twitter/sources.json`:
